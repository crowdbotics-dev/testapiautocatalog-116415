...
## Project Structure
    ...
    ├── testapiautocatalog_116415  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116415`
...
2. Clone this repo and `cd testapiautocatalog_116415`
